    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('store_item') }}">{{ __('Manage Item') }}</a>
                </li>
                    <li class="">
                        ...
                        <a href="{{ route('shopping_cart') }}" class="btn btn-default mx-4">
                            ...
                            <span
                                class="badge bg-dark text-light">{{ Session::has('cart') ? Session::get('cart')->total_quantity : '' }}</span>

                        </a>
                    </li>
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle btn btn-default mx-4" data-toggle="dropdown" role="button"
                            aria-haspopup="true" aria-expanded="false">
                            <i class="fa fa-user" aria-hidden="true"> </i> {{ Auth::user()->name }} <span
                                class="caret"></span></a>
                        <ul class="dropdown-menu">
                            <li><a href="#" class="dropdown-item">User profile</a></li>
                            <li><a href="/store" class="dropdown-item">Add item </a></li>
                            <li><a href="/store_item" class="dropdown-item">Item</a></li>
